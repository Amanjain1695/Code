     ...
     stages {
       ...
       stage('Authorize DevHub') {
                              steps {
                                ...
                                sh 'sfdx force:auth:jwt:grant --instanceurl https://login.salesforce.com --clientid 3MVG9pRzvMkjMb6nKN_QGvi32g_ZANpKZaYFpiOoonEynTpKJXumZp439yEPg0zccOkWGAVleKqNImUq5ZCqu --username ratneshkumar1166@gmail.com --jwtkeyfile https://github.com/captainratnesh/TractTest1/blob/master/server.key --setdefaultdevhubusername --setalias HubOrg'
                              }
                 }
